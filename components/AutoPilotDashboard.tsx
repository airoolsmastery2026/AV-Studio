...
const AutoPilotDashboard: React.FC<AutoPilotDashboardProps> = ({ 
    ...
    const NICHES = [
        { value: 'AUTO', label: "🤖 AUTO - Chế độ Tự động" },
        { value: 'AI_SAAS_TOOLS', label: "🛠️ AI SaaS Tools" },
        { value: 'ML_PLATFORMS', label: "🧠 Machine Learning Platforms" },
        { value: 'AI_PRODUCTIVITY', label: "⚡ AI Productivity Hacks" },
        { value: 'PASSIVE_INCOME', label: "💰 Phương pháp Kiếm tiền Thụ động" },
        { value: 'SMART_HOME', label: "🏠 Thiết bị Nhà thông minh" },
